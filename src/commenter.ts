...
export const COMMENT_GREETING = `${getInput('bot_icon')}   CoreDuck`;

export const COMMENT_TAG = '<!-- This is an auto-generated comment by OSS CoreDuck -->';

export const COMMENT_REPLY_TAG = '<!-- This is an auto-generated reply by OSS CoreDuck -->';

export const SUMMARIZE_TAG = '<!-- This is an auto-generated comment: summarize by OSS CoreDuck -->';

export const IN_PROGRESS_START_TAG =
    '<!-- This is an auto-generated comment: summarize review in progress by OSS CoreDuck -->';

export const IN_PROGRESS_END_TAG =
    '<!-- end of auto-generated comment: summarize review in progress by OSS CoreDuck -->';

export const DESCRIPTION_START_TAG = '<!-- This is an auto-generated comment: release notes by OSS CoreDuck -->';
export const DESCRIPTION_END_TAG = '<!-- end of auto-generated comment: release notes by OSS CoreDuck -->';

export const RAW_SUMMARY_START_TAG = `<!-- This is an auto-generated comment: raw summary by OSS CoreDuck -->
<!--
`;
...
<!-- end of auto-generated comment: short summary by OSS CoreDuck -->`;
